.data
my_list: .word -6, -2, -1, 0, 3, 4, 5, 7, 8, 9 # Sorted integer list
...
li $t3, 0 # flag for list does not contains target
...
end_loop:
	bne $t3, $zero, end_if # If $t5 = 0 target item is not in the list
	li $v0, 4
